...
|---|------|---------|------------|-------|--------|
| 4.1 | Route-level code split — `React.lazy` + `Suspense` `pages/**.tsx` (Phase 2+3 borcu, 348KB gzip) | 2 saat | — | ✅ Tamam | `TBD` |
| 4.2 | Zod introduction — `lib/validation.ts` + mock-exam/study-pack endpoint'lerine retrofit (Phase 3 borcu) | 3 saat | — | ⏳ | — |
