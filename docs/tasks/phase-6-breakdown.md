...
|---|------|---------|------------|-------|--------|
| 6.1 | vitest 2→4 upgrade + per-worker schema default flip (D1 kapanışı) | 4 saat | — | ✅ | _pending commit_ |
| 6.2 | Phase 0/1 error shape migration — 6 controller + client `api.ts` interceptor (50+ call) | 4 saat | 5.3 infra | ⬜ | — |
