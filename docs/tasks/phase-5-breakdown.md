...
| 5.12 | Course advisor — `scoreCompatibility` (style 30 + difficulty 20 + topic 50 weights) + `getCompatibility` insufficient branches | 3 saat | 5.7, 5.8 | ✅ Tamam | `pending` |
...
**Toplam:** ~74 saat tahmin · Hedef gerçek: Phase 4 ritmi (~10-14 saat tek oturum). **İlerleme:** ⏳ **12/25 — course advisor tamam, spaced repetition + premium gating + endpoint'ler sırada.**
